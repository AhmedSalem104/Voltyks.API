...
namespace Voltyks.AdminControlDashboard.Interfaces
{
    public interface IAdminChargersService
    {
        ...
        Task<ApiResponse<AdminChargerDto>> CreateChargerAsync(CreateChargerDto dto, CancellationToken ct = default);
        Task<ApiResponse<AdminChargerDto>> UpdateChargerAsync(int id, UpdateChargerDto dto, CancellationToken ct = default);
