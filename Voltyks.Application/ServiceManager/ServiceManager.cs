...
namespace Voltyks.Application.ServicesManager
{
    public class ServiceManager(UserManager<AppUser> userManager,
        ...
        , IRedisService redisService) : IServiceManager
    {


      
        public IAuthService AuthService { get; } = new AuthService(userManager, httpContextAccessor, options, twilioSettings, redisService);
