...
namespace Voltyks.Persistence.Data.Migrations
{
    ...
    [Migration("20260609115449_AddAntiRestrictionModes")]
    partial class AddAntiRestrictionModes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Voltyks.Persistence.Entities.Main.AppSettings", b =>
                {
                    ...
                    b.Property<bool>("AdminsModeActivated")
                        .HasColumnType("bit");

                    b.Property<bool>("AntiOtpRestrictionMode")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<bool>("AntiPaymentRestrictionMode")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedAt = new DateTime(2026, 6, 9, 11, 54, 48, 414, DateTimeKind.Utc).AddTicks(2112)
                        });
                });
            ...
            modelBuilder.Entity("Voltyks.Persistence.Entities.Main.ChargerAdapter", b =>
                {
                    ...
                    b.HasKey("ChargerId", "ProtocolId");

                    b.HasIndex("ProtocolId")
                        .HasDatabaseName("IX_ChargerAdapters_ProtocolId");

                    b.ToTable("ChargerAdapters", (string)null);
                });
            ...
            modelBuilder.Entity("Voltyks.Persistence.Entities.Main.FeesConfig", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MinimumFee = 40m,
                            Percentage = 10m,
                            UpdatedAt = new DateTime(2026, 6, 9, 11, 54, 48, 420, DateTimeKind.Utc).AddTicks(6888),
                            UpdatedBy = "system"
                        });
                });
            ...
            modelBuilder.Entity("Voltyks.Persistence.Entities.Main.NotificationBroadcast", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("DbPersistedCount")
                        .HasColumnType("int");

                    b.Property<int>("FcmAttemptedCount")
                        .HasColumnType("int");

                    b.Property<int>("FcmSucceededCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Voltyks.Persistence.Entities.Main.NotificationTemplate", b =>
                {
            ...
            modelBuilder.Entity("Voltyks.Persistence.Entities.Main.Paymob.RevokedCardToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Voltyks.Persistence.Entities.Main.Process", b =>
                {
                    ...
                    b.Property<bool>("DefaultRatingApplied")
                        .HasColumnType("bit");

                    b.Property<decimal?>("EstimatedPrice")
                        .HasColumnType("decimal(18,2)");

                    b.Property<DateTime?>("RatingWindowOpenedAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Voltyks.Persistence.Entities.Main.VehicleAdditionRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("VehicleAdditionRequests");
                });
